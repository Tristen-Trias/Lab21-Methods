public class Lab21_5 {
   ...
   // Fill-in the appropriate methods to complete the lab
	public static long squareSum(int num) {
		int subTotal = 0;
		for (int i = 0; i <= num; i++) {
			subTotal += i * i;
	...
	public static long squareSum(long[] arr, int num) {
		for (int i = 1; i <= num; i++) {
			if (arr[i] == 0) {
				arr[i] = arr[i-1] + (i * i);	
	...
	public static long fib(long[] arr, int num) {
		arr[1] = 1;
		for (int i = 2; i <= num; i++) {
			if (arr[i] == 0) {
	...
	public static long factorial(long[] arr, int num) {
		arr[1] = 1;
		for (int i = 2; i <= num; i++) {
			if (arr[i] == 0) {
				arr[i] = arr[i-1] * i;	
